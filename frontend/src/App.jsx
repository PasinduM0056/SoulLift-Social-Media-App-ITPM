...
function App() {
  ...
  return (
    <Box position="relative" w='full'>
      ...
      <Container className='grid-container' maxW="1700px">
      {(pathname === '/userDashboard/:username/cdhome' || pathname === '/userDashboard/:username/cdposts' || pathname === '/userDashboard/:username/cdpackage' || pathname === '/userDashboard/:username/cdadvertisement' || pathname === '/userDashboard/:username/cdbuyers' || pathname === '/userDashboard/:username/cdaddanalyse' || pathname === '/userDashboard/:username/cdprofile' || pathname === '/userDashboard/:username/cdsettings' ) && <CDSideBar />}
        <Routes>
            <Route path='/userDashboard/:username/cdhome' element={<CDHomePage />} />
            <Route path='/userDashboard/:username/cdpackage' element={<CDPackagePage />} />
            <Route path='/userDashboard/:username/cdadvertisement' element={<CDAdvertisementPage />} />
            <Route path='/userDashboard/:username/cdproduct/:pid' element={<CDBuyersPage />} />
            <Route path='/userDashboard/:username/cdaddanalyse' element={<CDAddAnalysePage />} />
            <Route path='/userDashboard/:username/cdprofile' element={<CDProfilePage />} />
            <Route path='/userDashboard/:username/cdchats' element={<CDChatPage />} />
            <Route path='/userDashboard/:username/cdsettings' element={<CDSettingsPage />} />
